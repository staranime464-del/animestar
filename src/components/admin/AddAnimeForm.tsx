...
const AddAnimeForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const formData = { 
        ...
        subDubStatus: form.subDubStatus,
        genreList: form.genreList,
        status: form.status,
  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="mb-6 bg-dark-gray-600 p-4 rounded-xl border border-gray-600">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-dark-gray-600 p-6 rounded-xl border border-gray-600">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-dark-gray-500 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-anime-green-400 focus:border-anime-green-400 transition"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-dark-gray-500 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-anime-green-400 focus:border-anime-green-400 transition h-24"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Sub/Dub Status</label>
                <select
        ...
        <div className="mb-6 pb-4 border-b border-gray-600">
          <h3 className="text-lg font-semibold text-white mb-4">
            SEO Settings <span className="text-xs text-anime-green-400">(Important for Google Search)</span>
          </h3>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                SEO Title
                <span className="text-gray-400 text-xs ml-2">(Appears in Google search results)</span>
              </label>
              <input
                type="text"
                value={form.seoTitle}
              ...
              <div className="flex justify-between mt-1">
                <p className="text-gray-400 text-xs">
                  Character count: <span className={form.seoTitle.length > 60 ? 'text-anime-red-400' : 'text-anime-green-400'}>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                SEO Description
                <span className="text-gray-400 text-xs ml-2">(Appears below title in Google search)</span>
              </label>
              <textarea
              ...
              <div className="flex justify-between mt-1">
                <p className="text-gray-400 text-xs">
                  Character count: <span className={form.seoDescription.length > 160 ? 'text-anime-red-400' : 'text-anime-green-400'}>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                SEO Keywords
                <span className="text-gray-400 text-xs ml-2">(Important for search rankings)</span>
              </label>
              <textarea
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                URL Slug Preview
                <span className="text-gray-400 text-xs ml-2">(Auto-generated by backend, SEO-friendly)</span>
              </label>
              
              <div className="mt-2 p-3 bg-dark-gray-500 rounded-lg border border-gray-600">
                <p className="text-anime-green-400 text-xs font-medium mb-1">Generated URL Preview:</p>
                <p className="text-gray-300 text-sm font-mono break-all">
                  https://animestar.in/detail/{previewSlug || 'your-anime-slug-will-appear-here'}
                </p>
                <p className="text-gray-400 text-xs mt-2">
                  ✅ This SEO-friendly URL will be auto-generated by backend. Make sure title is descriptive.
                </p>
                <p className="text-yellow-400 text-xs mt-1">
                  ⚠️ Note: Final slug may differ slightly. Backend ensures uniqueness.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Submit Button */}
        <div className="bg-dark-gray-500 p-4 rounded-lg border border-gray-600">
          <div className="flex items-center justify-between mb-3">
            <div>
              <h4 className="text-white font-semibold">Ready to Publish?</h4>
              <p className="text-gray-400 text-xs">This anime will appear in Google Search results</p>
            </div>
            <div className="text-right">
              <p className="text-anime-green-400 text-sm font-medium">SEO Optimized: {autoGenerateSEO ? 'Yes' : 'No'}</p>
              <p className="text-gray-400 text-xs">Google Indexing: 24-48 hours</p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full btn-gradient-green disabled:opacity-50 flex items-center justify-center shadow-lg hover:shadow-green-glow"
          >
            {loading ? (
              <>
        ...
        {success && (
          <div className="p-4 bg-dark-gray-500 border border-anime-green-400/30 rounded-lg">
            <div className="flex items-start gap-3">
              <div className="text-anime-green-400 text-xl">✅</div>
              <div>
                <p className="text-anime-green-400 text-sm font-semibold mb-1">Successfully Published!</p>
                <p className="text-gray-300 text-sm">{success}</p>
                <div className="mt-2 p-2 bg-dark-gray-600 rounded">
                  <p className="text-anime-green-400 text-xs">Backend will auto-generate SEO-friendly slug</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {error && (
          <div className="p-4 bg-dark-gray-500 border border-anime-red-500/30 rounded-lg">
            <div className="flex items-start gap-3">
              <div className="text-anime-red-400 text-xl">❌</div>
              <div>
                <p className="text-anime-red-400 text-sm font-semibold mb-1">Error</p>
